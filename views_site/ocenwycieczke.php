...
<div id="content2">
    <div class="ocenacenter">
        <br><br><h2>Oceń przebytą wycieczkę. </h2>
        <br>


        <form action="site.php?action=ocenawycieczkiinsert" method="post">
            ...
            <span class="tekst" >Co Ci sie podobało lub nie w wycieczce?</span><br>
